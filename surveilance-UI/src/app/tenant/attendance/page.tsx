        ...
        <div className="p-8 space-y-8 max-w-[1600px] mx-auto">
            ...
            <div className="bg-white rounded-3xl p-6 sm:p-8 border border-gray-100 shadow-sm flex flex-col md:flex-row md:items-center md:justify-between gap-6">
                <div className="space-y-2">
                    ...
                    <h1 className="text-2xl sm:text-3xl font-extrabold tracking-tight text-gray-900">Attendance & Shift Records</h1>
                ...
                <div className="flex items-center gap-3">
                    <div className="bg-gray-50 border border-gray-200 rounded-2xl px-4 py-2.5 flex items-center gap-3">
                    ...
                    <button
                        onClick={fetchData}
                        disabled={isLoading}
                        className="bg-blue-600 hover:bg-blue-700 text-white p-3 rounded-2xl transition-all shadow-sm hover:shadow-md active:scale-95 disabled:opacity-50"
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-5">
                ...
                <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Total Present Today</span>
                        <div className="w-10 h-10 rounded-2xl bg-emerald-50 border border-emerald-100 flex items-center justify-center text-emerald-600">
                            <Users className="w-5 h-5" />
                        </div>
                    </div>
                    <div className="mt-4 flex items-baseline gap-2">
                        <span className="text-3xl font-black text-gray-900">{summary?.totalPresent ?? 0}</span>
                ...
                <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Day Shift Count</span>
                        <div className="w-10 h-10 rounded-2xl bg-amber-50 border border-amber-100 flex items-center justify-center text-amber-600">
                            <Sun className="w-5 h-5" />
                        </div>
                    </div>
                    <div className="mt-4 flex items-baseline gap-2">
                        <span className="text-3xl font-black text-gray-900">{summary?.dayShiftCount ?? 0}</span>
                ...
                <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Night Shift Count</span>
                        <div className="w-10 h-10 rounded-2xl bg-purple-50 border border-purple-100 flex items-center justify-center text-purple-600">
                            <Moon className="w-5 h-5" />
                        </div>
                    </div>
                    <div className="mt-4 flex items-baseline gap-2">
                        <span className="text-3xl font-black text-gray-900">{summary?.nightShiftCount ?? 0}</span>
                ...
                <div className="bg-white rounded-3xl p-6 border border-gray-100 shadow-sm hover:shadow-md transition-shadow relative overflow-hidden group">
                    <div className="flex items-center justify-between">
                        <span className="text-xs font-bold text-gray-400 uppercase tracking-wider">Avg Shift Duration</span>
                ...
                <form onSubmit={handleSearchSubmit} className="flex items-center gap-3 flex-1 max-w-md">
                    <div className="relative flex-1">
                        ...
                        <input
                            ...
                            className="w-full bg-gray-50/80 border border-gray-200 rounded-2xl pl-11 pr-4 py-2.5 text-sm font-medium text-gray-900 placeholder:text-gray-400 focus:bg-white focus:outline-none focus:ring-2 focus:ring-blue-500/20 focus:border-blue-500 transition-all"
                        />
                    </div>
                    <button
                        type="submit"
                        className="bg-blue-600 hover:bg-blue-700 text-white px-5 py-2.5 rounded-2xl text-xs font-semibold shadow-sm transition-colors"
                    >
                        Search
                    </button>
                </form>
            ...
            <div className="bg-white rounded-3xl border border-gray-100 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-gray-100 flex items-center justify-between">
                    <div>
                        <h2 className="text-lg font-bold text-gray-900">Shift Log & Duration</h2>
                        <p className="text-xs text-gray-500 mt-0.5">Showing daily aggregated First-In and Last-Out camera timestamps</p>
                    </div>
                ...
                {isLoading ? (
                    <div className="p-12 text-center text-gray-400 font-medium animate-pulse flex flex-col items-center gap-2">
                    ...
                    <div className="p-16 text-center text-gray-400 flex flex-col items-center gap-3">
                        ...
                        <div>
                            ...
                            <p className="text-xs text-gray-400 mt-0.5">No check-in or check-out events match the selected filter criteria.</p>
                        </div>
                    </div>
                ) : (
                                ...
                                {records.map((rec) => (
                                    <tr key={rec.id} className="hover:bg-gray-50/50 transition-colors">
                                        ...
                                        <td className="py-4 px-6">
                                            <div className="flex items-center gap-3">
                                                <div className="w-9 h-9 rounded-2xl bg-blue-50 border border-blue-100 flex items-center justify-center text-blue-600 font-bold text-xs">
                                                    {rec.employeeExternalId.substring(0, 3)}
                                                </div>
                                                <div>
                                                    <span className="font-semibold text-gray-900 block">{rec.employeeName || rec.employeeExternalId}</span>
                                                    <span className="text-xs font-mono text-gray-400">{rec.employeeExternalId}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="py-4 px-6">
                                            {rec.shiftType === 'NightShift' ? (
                                                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-purple-50 text-purple-700 border border-purple-200/60 text-xs font-semibold">
                                                    <Moon className="w-3 h-3 text-purple-500" /> Night Shift
                                                </span>
                                            ) : (
                                                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-amber-50 text-amber-700 border border-amber-200/60 text-xs font-semibold">
                                        ...
                                        <td className="py-4 px-6">
                                            <div className="flex items-center gap-2 text-gray-700">
                                                ...
                                                <div>
                                                    <span className="font-bold text-gray-900 block">{formatTime(rec.firstInTime)}</span>
                                                    <span className="text-[11px] text-gray-400">{rec.firstInCameraName || 'Entry Gate'}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        <td className="py-4 px-6">
                                            <div className="flex items-center gap-2 text-gray-700">
                                                ...
                                                <div>
                                                    <span className="font-bold text-gray-900 block">{formatTime(rec.lastOutTime)}</span>
                                                    <span className="text-[11px] text-gray-400">{rec.lastOutCameraName || 'Exit Gate'}</span>
                                                </div>
                                            </div>
                                        </td>
                                        ...
                                        {/* Work Duration */}
                                        <td className="py-4 px-6">
                                            <div className="inline-flex items-center gap-1.5 px-3 py-1 rounded-xl bg-gray-100 text-gray-800 text-xs font-bold font-mono">
                                        ...
                                        <td className="py-4 px-6">
                                            ...
                                            {rec.status === 'InShift' && (
                                                <span className="inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-blue-50 text-blue-700 border border-blue-200/60 text-xs font-semibold animate-pulse">
