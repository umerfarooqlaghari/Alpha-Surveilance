...
namespace violation_management_api.Migrations
{
    ...
    [Migration("20260904224259_AddWorkstationOperatingSchedules")]
    partial class AddWorkstationOperatingSchedules
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("violation_management_api.Core.Entities.AiModel", b =>
                {
                    ...
                    b.Property<bool>("RequiresCropping")
                        .HasColumnType("boolean");

                    b.Property<bool>("RequiresHumanPresence")
                        .HasColumnType("boolean");
            ...
            modelBuilder.Entity("violation_management_api.Core.Entities.AttendanceLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("violation_management_api.Core.Entities.AttendanceRecord", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<Guid?>("FirstInCameraId")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("FirstInTime")
                        .HasColumnType("timestamp with time zone");

                    b.Property<Guid?>("LastOutCameraId")
                        .HasColumnType("uuid");
                    ...
                    b.Property<double>("TotalWorkMinutes")
                        .HasColumnType("double precision");
                    ...
                    b.HasIndex("FirstInCameraId");

                    b.HasIndex("LastOutCameraId");
                    ...
                    b.HasIndex("TenantId", "EmployeeId", "ShiftDate")
                        .IsUnique();
            ...
            modelBuilder.Entity("violation_management_api.Core.Entities.ReliefSession", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int?>("HandoverLatencySeconds")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("PrimaryEmployeeExternalId")
                        .HasColumnType("text");

                    b.Property<Guid?>("PrimaryEmployeeId")
                        .HasColumnType("uuid");

                    b.Property<DateTime>("PrimaryLeftAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<int?>("ReliefDurationSeconds")
                        .HasColumnType("integer");

                    b.Property<DateTime?>("ReliefEndedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<DateTime?>("RelieverArrivedAt")
                        .HasColumnType("timestamp with time zone");

                    b.Property<string>("RelieverEmployeeExternalId")
                        .HasColumnType("text");
            ...
            modelBuilder.Entity("violation_management_api.Core.Entities.WorkerProfile", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("TenantId", "PersonTag");

                    b.ToTable("worker_profiles", (string)null);
                });

            modelBuilder.Entity("violation_management_api.Core.Entities.Workstation", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("HandoverThresholdSeconds")
                        .HasColumnType("integer");
                    ...
                    b.Property<int>("MaxReliefDurationSeconds")
                        .HasColumnType("integer");

                    b.Property<int>("MaxRelievers")
                        .HasColumnType("integer");
                    ...
                    b.Property<string>("OperatingScheduleJson")
                        .HasColumnType("jsonb");
                    ...
                    b.Property<int>("RequiredPrimaryWorkers")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("violation_management_api.Core.Entities.WorkstationDowntimeLog", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.ToTable("WorkstationDowntimeLogs");
                });

            modelBuilder.Entity("violation_management_api.Core.Entities.WorkstationWorkerAssignment", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("WorkstationId", "EmployeeId", "Role")
                        .IsUnique();

                    b.ToTable("WorkstationWorkerAssignments");
                });
            ...
            modelBuilder.Entity("violation_management_api.Core.Entities.AttendanceLog", b =>
                {
                    b.HasOne("violation_management_api.Core.Entities.AttendanceRecord", "AttendanceRecord")
                        .WithMany()
            ...
            modelBuilder.Entity("violation_management_api.Core.Entities.AttendanceRecord", b =>
                {
                    ...
                    b.HasOne("violation_management_api.Core.Entities.Camera", "FirstInCamera")
                        .WithMany()
                        .HasForeignKey("FirstInCameraId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("violation_management_api.Core.Entities.Camera", "LastOutCamera")
                        .WithMany()
                        .HasForeignKey("LastOutCameraId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.Navigation("Employee");

                    b.Navigation("FirstInCamera");

                    b.Navigation("LastOutCamera");
                });
            ...
            modelBuilder.Entity("violation_management_api.Core.Entities.ReliefSession", b =>
                {
                    ...
                    b.HasOne("AlphaSurveilance.Core.Domain.Employee", "PrimaryEmployee")
                        .WithMany()
                        .HasForeignKey("PrimaryEmployeeId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("AlphaSurveilance.Core.Domain.Employee", "RelieverEmployee")
                        .WithMany()
                    ...
                    b.HasOne("violation_management_api.Core.Entities.Workstation", "Workstation")
                        .WithMany("ReliefSessions")
